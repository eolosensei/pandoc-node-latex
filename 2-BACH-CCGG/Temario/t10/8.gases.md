...
:     son las características que presentan todos los cuerpos y que **no** sirven para diferenciar sustancias. Las dos principales son la masa y el volumen, pero también son propiedades generales el peso, la temperatura, la inercia o la divisibilidad.
...
**Ley de Boyle-Mariotte**
:     A temperatura constante, el producto de la presión por el volumen de un gas permanece constante.
$$pV = cte \qquad p_1V_1 = p_2V_2$$

#### Ejemplo 9
*Las medidas tomadas para un gas a una temperatura concreta se recogieron en la siguiente tabla.*
...
Como se ve, el producto $pV$ es 4 en todos los casos, por lo que la ley de Boyle para este caso concreto será $p \cdot V = 4$. A otra temperatura, $pV$ tendrá otro valor distinto.*

#### Ejemplo 10
*Un gas ocupa 5,3#L a una presión de 1,5#atm. ¿A cuánta presión estará si se disminuye su volumen a 2#L?*

$$1,5#atm \cdot 5,3#L = p_2 \cdot 2#L \qquad \Longrightarrow \qquad p_2 = 1,5#atm \cdot \frac{5,3#L}{2#L} \qquad \Longrightarrow \qquad p_2 = 3,975#atm$$
