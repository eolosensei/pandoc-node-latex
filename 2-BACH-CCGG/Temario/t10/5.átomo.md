...
Neutrón          0                 1,6749e-27#kg (1#uma)       J. Chadwick, 1932
--------------  ----------------  -----------------------  ---------------------
...
![Experimento de Rutherford](image-1.png){ width=75% }
...
![Modelo de Rutherford](image-2.png)
...
- Los electrones absorben o emiten energía al cambiar de órbita. Para que un electrón pase de una órbita a otra más lejana del núcleo deberá absorber energía, ya que pasa a un nivel energético mayor. Por el contrario, al pasar a una órbita más cercana al núcleo (y, por tanto, con un nivel de energía menor) desprenderá energía en la forma de un fotón de luz.
  ...
  ![Saltos de energía entre órbitas, según Bohr](image-4.png){ width=75% }
...
Por lo tanto, conociendo **Z** y **A** es posible conocer el número de partículas subatómicas presentes en un átomo.
![Representación atómica](image-7.png){width=25%}
Para representar un átomo de un elemento químico es habitual escribirlo con el símbolo del elemento, rodeado de sus valores de número atómico (Z, en la parte inferior izquierda) y número másico (A, en la parte superior izquierda). La esquina superior derecha se reserva para indicar la carga en el caso de los iones, mientras la esquina inferior derecha señala el número de átomos del elemento.
...
Como podemos ver, el número de protones coincide con el de electrones, pero no tiene por qué ser el mismo que el de neutrones.

El número atómico (de protones) de un elemento químico es invariable, pero el de
neutrones puede ser diferente. Dos átomos pueden tener el mismo número de protones (son, por tanto, el mismo elemento químico) pero distinto número de neutrones.
...
Se conocen isótopos de casi todos los elementos químicos, pero los hay en distinta proporción según el isótopo y el elemento químico. Por ejemplo, se conocen tres isótopos del hidrógeno: protio, deuterio y tritio, siendo el protio el más abundante (99,98% de abundancia). El carbono-14 (C-14 o \ch{^{14}C}) es un isótopo del carbono con 8 neutrones.

![Isótopos del átomo de hidrógeno](image-8.png){ width=60% }
...
**Aniones**
: átomo que ha ganado electrones, adquiriendo carga negativa y convirtiéndose en un ion negativo. Ejemplos: \ch{Cl-} \ch{O^2-}
...
![Diagrama de Moeller](IMG-2CCG-Diagrama de Moeller.jpg){ width=50% }
...
#### Ejemplo 6:
*Representa la configuración electrónica del cloro (Cl)*
...
#### Ejemplo 7:
*Configuración electrónica del Br ($Z = 35$).*
...
#### Ejemplo 8:
*Escribe la configuración electrónica del \ch{K+} ($Z = 19$)*
