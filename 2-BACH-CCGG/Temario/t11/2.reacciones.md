...
![](media/image2.jpeg){width=2.64in height=1.40in}
...
![](media/image3.png){width=3.12in height=1.62in}
...
![Diferencias de reactividad entre choques](media/image7.png){width=4.72in height=2.06in}
...
![Las moléculas se encuentran más juntas si reducimos el volumen](media/image11.png){ width=50% }
